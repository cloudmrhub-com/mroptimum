function OUTCLASS=  CRtask(signalfilename,noisefilename,jop,resultfilename,logfilename,QSRVR)
warning('off');
...
%             end
        ...
        [O(sl),L(sl)]=CRWORKER(KSS,KSN,o,KSENS,FA,['slice number # ' num2str(sl)]);
